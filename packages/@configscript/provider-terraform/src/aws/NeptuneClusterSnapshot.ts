...
export interface NeptuneClusterSnapshotArguments {
  db_cluster_identifier: string
  db_cluster_snapshot_identifier: string
  id?: string
}

export interface NeptuneClusterSnapshotAttributes {
...
export class NeptuneClusterSnapshot extends Resource<
  NeptuneClusterSnapshotArguments,
  NeptuneClusterSnapshotAttributes
> {
  _kind = 'aws_neptune_cluster_snapshot'
