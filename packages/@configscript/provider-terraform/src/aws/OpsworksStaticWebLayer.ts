...
export interface OpsworksStaticWebLayerArguments {
...
export interface OpsworksStaticWebLayerAttributes {
  auto_assign_elastic_ips?: boolean
  auto_assign_public_ips?: boolean
  auto_healing?: boolean
  custom_configure_recipes?: Array<string>
...
export class OpsworksStaticWebLayer extends Resource<
  OpsworksStaticWebLayerArguments,
  OpsworksStaticWebLayerAttributes
> {
  _kind = 'aws_opsworks_static_web_layer'
