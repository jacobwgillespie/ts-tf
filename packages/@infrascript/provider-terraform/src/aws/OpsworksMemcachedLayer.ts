...
export interface OpsworksMemcachedLayerArguments {
...
export interface OpsworksMemcachedLayerAttributes {
  allocated_memory?: number
  auto_assign_elastic_ips?: boolean
  auto_assign_public_ips?: boolean
  auto_healing?: boolean
...
export class OpsworksMemcachedLayer extends Resource<
  OpsworksMemcachedLayerArguments,
  OpsworksMemcachedLayerAttributes
> {
  _kind = 'aws_opsworks_memcached_layer'

  get allocated_memory() {
    return this._attr('allocated_memory')
  }
