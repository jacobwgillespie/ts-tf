import {createProviderFactory, ProviderConfigType} from 'ts-terraform'
...
interface ProviderConfig extends ProviderConfigType {
  ...
  dataSourceSchemas: {
    ...
    aws_directory_service_directory: {
      ...
      tags?: Record<string, string>
      type?: string
      vpc_settings?: Array<{subnet_ids: Array<string>; vpc_id: string}>
    }
    aws_ec2_coip_pools: {
      id?: string
  ...
  resourceSchemas: {
    ...
    aws_directory_service_directory: {
      ...
      vpc_settings?: {subnet_ids: Array<string>; vpc_id: string}
    }
