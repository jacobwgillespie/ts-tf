...
export class OpsworksHaproxyLayer extends Resource<OpsworksHaproxyLayerArguments, OpsworksHaproxyLayerAttributes> {
  _kind = 'aws_opsworks_haproxy_layer'
  ...
  get healthcheck_method() {
    return this._attr('healthcheck_method')
  }

  get healthcheck_url() {
    return this._attr('healthcheck_url')
  }
  ...
  get stats_enabled() {
    return this._attr('stats_enabled')
  }

  get stats_password() {
    return this._attr('stats_password')
  }

  get stats_url() {
    return this._attr('stats_url')
  }

  get stats_user() {
    return this._attr('stats_user')
  }
